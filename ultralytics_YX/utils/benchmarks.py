...
Usage:
    from ultralytics_YX.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_YX import YOLO, YOLOWorld
from ultralytics_YX.cfg import TASK2DATA, TASK2METRIC
from ultralytics_YX.engine.exporter import export_formats
from ultralytics_YX.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_YX.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics_YX.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics_YX.utils.benchmarks import ProfileModels

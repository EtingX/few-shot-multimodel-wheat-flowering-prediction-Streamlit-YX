...
def spaces_in_path(path):
    ...
    Example:
        ```python
        with ultralytics_YX.utils.files import spaces_in_path
...
def update_models(model_names=("yolov8n.pt",), source_dir=Path("."), update_names=False):
    ...
    Example:
        ```python
        from ultralytics_YX.utils.files import update_models
    ...
    from ultralytics_YX.nn.autobackend import default_class_names

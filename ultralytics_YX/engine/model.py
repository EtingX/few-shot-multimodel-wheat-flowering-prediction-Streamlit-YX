...
from ultralytics_YX.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_YX.hub.utils import HUB_WEB_ROOT
from ultralytics_YX.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from ultralytics_YX.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics_YX.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics_YX.hub.session import HUBTrainingSession
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (ultralytics_YX.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (ultralytics_YX.engine.model.Model): The instance of the class with loaded weights.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_YX import __version__
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (sys.argv[0].endswith("yolo") or sys.argv[0].endswith("ultralytics_YX")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics_YX.engine.results.Results]): A list of tracking results, encapsulated in the Results class.

        Raises:
            AttributeError: If the predictor does not have registered trackers.
        """
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_YX.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the ultralytics_YX.utils.benchmarks module. The benchmarking is configured
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_YX.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralytics_YX.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_YX.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the ultralytics_YX.nn.autobackend module.

        Returns:
            (list | None): The class names of the model if available, otherwise None.
        """
        from ultralytics_YX.nn.autobackend import check_class_names
